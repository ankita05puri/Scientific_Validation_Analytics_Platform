    ...
    for study in studies:
        cards.append(
            ...
            <div class="summary-card">
              ...
              <div class="summary-subtext">{escape(study.study_name)}<br>{escape(study.date)}</div>
            </div>
            """
        )
...
def build_full_report_html(
    ...
    report_version = package.project_metadata.get("Report Version", "v0.7.1")
    return f"""<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <section class="page-break" id="sign-off">
    ...
    <div class="signature-grid">
      <div><div class="signature-line"></div><strong>Prepared By:</strong></div>
      <div><div class="signature-line"></div><strong>Reviewed By:</strong></div>
